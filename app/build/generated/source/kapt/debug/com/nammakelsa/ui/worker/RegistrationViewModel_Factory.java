...
public final class RegistrationViewModel_Factory implements Factory<RegistrationViewModel> {
  ...
  public RegistrationViewModel_Factory(Provider<WorkerRepository> workerRepositoryProvider,
  ...
  public static RegistrationViewModel_Factory create(
      ...
      Provider<LocationRepository> locationRepositoryProvider,
      Provider<FirebaseAuth> firebaseAuthProvider) {
    return new RegistrationViewModel_Factory(workerRepositoryProvider, storageRepositoryProvider, locationRepositoryProvider, firebaseAuthProvider);
  }

  public static RegistrationViewModel newInstance(WorkerRepository workerRepository,
      StorageRepository storageRepository, LocationRepository locationRepository,
      FirebaseAuth firebaseAuth) {
    return new RegistrationViewModel(workerRepository, storageRepository, locationRepository, firebaseAuth);
  }
}
