...
public abstract class Hilt_WorkerProfileViewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WorkerProfileViewFragment() {
    super();
  }

  Hilt_WorkerProfileViewFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerProfileViewFragment_GeneratedInjector) this.generatedComponent()).injectWorkerProfileViewFragment(UnsafeCasts.<WorkerProfileViewFragment>unsafeCast(this));
    }
  }
