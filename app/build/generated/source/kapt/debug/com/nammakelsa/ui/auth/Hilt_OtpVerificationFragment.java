...
public abstract class Hilt_OtpVerificationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OtpVerificationFragment() {
    super();
  }

  Hilt_OtpVerificationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OtpVerificationFragment_GeneratedInjector) this.generatedComponent()).injectOtpVerificationFragment(UnsafeCasts.<OtpVerificationFragment>unsafeCast(this));
    }
  }
