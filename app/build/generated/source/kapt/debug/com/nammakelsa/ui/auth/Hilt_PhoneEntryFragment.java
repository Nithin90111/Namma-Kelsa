...
public abstract class Hilt_PhoneEntryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhoneEntryFragment() {
    super();
  }

  Hilt_PhoneEntryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhoneEntryFragment_GeneratedInjector) this.generatedComponent()).injectPhoneEntryFragment(UnsafeCasts.<PhoneEntryFragment>unsafeCast(this));
    }
  }
