...
public abstract class Hilt_WorkerProfileEditFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WorkerProfileEditFragment() {
    super();
  }

  Hilt_WorkerProfileEditFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerProfileEditFragment_GeneratedInjector) this.generatedComponent()).injectWorkerProfileEditFragment(UnsafeCasts.<WorkerProfileEditFragment>unsafeCast(this));
    }
  }
